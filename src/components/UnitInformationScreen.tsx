...
function getAbilityDescription(unitType: UnitType): string {
  const abilityDescriptions: Record<UnitType, string> = {
    ...
    warrior: 'Dashes to the nearest enemy within 2m and deals 90 damage (5x attack damage). Also fires a laser dealing 10 damage.',
    ...
    berserker: 'Fires a laser dealing 10 damage and enters rage mode (placeholder - full implementation pending).',
    assassin: 'Fires a laser dealing 10 damage and performs a shadow strike (placeholder - full implementation pending).',
    juggernaut: 'Fires a laser dealing 10 damage and slams the ground (placeholder - full implementation pending).',
    striker: 'Fires a laser dealing 10 damage and spins in a whirlwind (placeholder - full implementation pending).',
    ...
    duelist: 'Counter-attack stance - creates a 2m shield for 2 seconds and deals 25 damage to nearby enemies. Also fires a laser dealing 10 damage.',
    reaper: 'Fires a laser dealing 10 damage. Soul strike ability (placeholder - full implementation pending).',
    oracle: 'Fires a laser dealing 10 damage. Divine restoration healing ability (placeholder - full implementation pending).',
    harbinger: 'Fires a laser dealing 10 damage. Ethereal strike ability (placeholder - full implementation pending).',
    
    // Solari faction
    flare: 'Fires a laser dealing 10 damage. Solar beam ability (placeholder - full implementation pending).',
    nova: 'Fires a laser dealing 10 damage. Stellar burst ability (placeholder - full implementation pending).',
    eclipse: 'Fires a laser dealing 10 damage. Shadow veil ability (placeholder - full implementation pending).',
    corona: 'Fires a laser dealing 10 damage. Radiation wave ability (placeholder - full implementation pending).',
    supernova: 'Fires a laser dealing 10 damage. Cosmic explosion ability (placeholder - full implementation pending).',
    zenith: 'Fires a laser dealing 10 damage. Solar blessing healing ability (placeholder - full implementation pending).',
    pulsar: 'Fires a laser dealing 10 damage. Stellar dive ability (placeholder - full implementation pending).',
    celestial: 'Fires a laser dealing 10 damage. Astral charge ability (placeholder - full implementation pending).',
