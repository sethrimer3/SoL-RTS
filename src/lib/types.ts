...
export const FACTION_DEFINITIONS: Record<FactionType, FactionDefinition> = {
  ...
  solari: {
    ...
    baseShape: 'circle',
    ability: 'pulse',
    availableUnits: ['flare', 'nova', 'eclipse', 'corona', 'supernova', 'zenith', 'pulsar', 'celestial', 'voidwalker', 'chronomancer', 'nebula', 'quasar', 'luminary', 'photon'],
